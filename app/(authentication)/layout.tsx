...
const AuthLayout = ({ children }: { children: ReactNode }) => {
  return (
    <main className="flex-iCenter-jCenter min-h-screen bg-[url('/images/auth-light.png')] bg-cover bg-center bg-no-repeat px-4 py-10 dark:bg-[url('/images/auth-dark.png')]">
      <section className="light-border background-light800_dark200 shadow-light100_dark100 min-w-full rounded-[10px] border px-4 py-10 shadow-md sm:min-w-[520] sm:px-8">
        <div className="flex-iCenter-jBetween gap-2">
